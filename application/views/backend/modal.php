<script type="text/javascript">
	function showAjaxModal(url){
		...
		jQuery('#modal_ajax .modal-body').html('<div style="text-align:center;margin-top:200px;"><img src="<?php echo base_url();?>assets/images/loader.svg" /></div>');
	...
	<div class="modal fade" id="modal-5">
        <div class="modal-dialog">
            <div class="modal-content" style="margin-top:100px;">
				...
				<div class="row">
				 <div class="col-sm-7">	
				ARE YOU SURE YOU WANT TO PUBLSIH THIS EXAMINATION ?
				</div>
				 <div class="col-sm-5">	
                    <a href="#" class="btn btn-success btn-rounded btn-sm" id="delete_link2"><i class="fa fa-check">&nbsp;</i>Publish</a>
                    <button type="button" class="btn btn-info btn-rounded btn-sm" data-dismiss="modal"><i class="fa fa-times">&nbsp;</i>Cancel</button>
					</div>
				</div>
				</div>
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="margin-top:100px;">
				...
				ARE YOU SURE YOU WANT TO UNPUBLSIH THIS EXAMINATION?
				 ...
				 <div class="col-sm-5">	
                    <a href="#" class="btn btn-success btn-rounded btn-sm" id="delete_link3"><i class="fa fa-check">&nbsp;</i>Unpublish</a>
                    <button type="button" class="btn btn-info btn-rounded btn-sm" data-dismiss="modal"><i class="fa fa-times">&nbsp;</i>Cancel</button>
					</div>
				</div>
				</div>
