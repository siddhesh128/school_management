<div class="col-sm-12">
	<div class="panel panel-info">                     
		<div class="panel-body table-responsive">
			...
			<a href="<?php echo site_url('admin/manage_online_exam/expired');?>" class="btn  btn-sm btn-<?php echo $status == 'expired' ? 'primary' : 'white'; ?>" style="color:#000">				<?php echo get_phrase('expired_exams');?>
			</a>
			<hr>
				...
				<tbody>
					...
					class="btn btn-xs btn-circle btn-danger" style="color:white">
						...
						<?php elseif ($row['status'] == 'published'): ?>
							<a href="#" onclick="unpublish_modal('<?php echo site_url('admin/manage_online_exam_status/'.$row['online_exam_id'].'/expired'); ?>', 'generic_confirmation');" type="button" class = "btn btn-danger btn-rounded btn-sm" style="color:white"><i class="fa fa-times" aria-hidden="true"></i> <?php echo get_phrase('cancel_now'); ?></a>
